...
password = 'sparta'
cxn_str = f'mongodb+srv://user:{password}@cluster0.uwkgh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
def detail(keyword):
    api_key = '50f60326-728e-45c3-8455-bce8e50e4fcf'
